...
NC='\033[0m' # White
echo -e "${RD}Currently, Arch isn't supported by Traktor. We Very Sorry, Please help us to develop Arch Installer... :(\n\n"
exit
...
sudo wget https://gitlab.com/TraktorPlus/Traktor/raw/config/dnscrypt-proxy.service-arch -O /usr/lib/systemd/system/dnscrypt-proxy.service > /dev/null
